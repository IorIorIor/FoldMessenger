...
object Config {
     ...
     * reveal comes later as a separate, tiny broadcast, so the bytes are off the
     * critical path and six phones can be alerted at the same instant.
     */
